...
import FloatingCan from "@/app/Section_61/component/FloatingCan";
...
function ThreeText({
  ...
  return words.map((word, wordIndex) => <Text key={`${wordIndex}-${word}`} scale={isDesktop ? 1 : 0.5} color={color} material={material} font="/fonts/Alpino-Variable.woff" fontWeight={900} anchorX={"center"} anchorY={"middle"} characters="ABCDEFGHIJKLMNOPQRSTUVWXYZ!,.?'">
      {word}
    </Text>);
}