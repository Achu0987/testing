...
const SHAPE_2 = "https://gramentheme.com/html/fresheat/assets/img/shape/ctaShape1_2.png"; // small round accent
const SHAPE_3 = "https://gramentheme.com/html/fresheat/assets/img/shape/ctaShape1_3.png"; // bottom-right tomatoes

export default function V162() {
  return (
    <section
    ...
    >
      <style>
        {`
          ...
          .shape-2 {
            animation: move2 4.8s ease-in-out infinite;
