...
export default function V342() {
  ...
  useEffect(() => {
    ...
    function setupAnimation(model) {
      ...
      gsap.set(planeGroup.scale, { x: 25, y: 25, z: 25 });
      ...
      delay += sectionDuration; //5
      tl.to(
        planeGroup.rotation,
        { x: 0, z: 0, y: tau * 0.25, ease: "power4.inOut" },
        delay
      );
      tl.to(planeGroup.position, { x: -20, y: -10, z: 50, ease: "power4.inOut" }, delay);
      tl.to(planeGroup.scale, { x: 15, y: 15, z: 15, ease: "power4.inOut" }, delay);
      ...
      tl.to(planeGroup.position, { x: 0, y: -10, z: 50, ease: "power4.inOut" }, delay);
      tl.to(planeGroup.scale, { x: 15, y: 15, z: 15, ease: "power4.inOut" }, delay);
      ...
      tl.to(
        planeGroup.position,
        { duration: sectionDuration, x: -20, y: 200, z: 50, ease: "power1.in" },
        delay
      );
      tl.to(
        planeGroup.scale,
        { duration: sectionDuration, x: 15, y: 15, z: 15, ease: "power1.in" },
        delay
      );
